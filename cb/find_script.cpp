...
struct FindScript:public Callback
{
    ...
    FindScript()
    {
        parser
            .usage("")
            .version("")
            .description("dump all txs with OP_RETURN")
            .epilog("")
        ;
    }

    virtual const char                   *name() const         { return "findscript"; }
    ...
    )
    {
        ...
        info("Dumping all txs with output scripts OP_RETURN");
        return 0;
    }
